	...
	<p class="bitstream">Core CSS components make up the bulk of BF. The included CSS files are uncompressed (unminified), and are located in the <span class="bold red">bos/core/css</span> folder.</p>
	<div class="flex"><div class="padded half">
		<h4 class="charcoal white-t flow-text bitstream">Construct CSS</h4>
		<p class="bitstream" style="margin-bottom: 1em;">All CSS files can be loaded independently, or you could use <span class="bold red">bos/core/css/construct.css</span> to import all CSS files and load them via this one file all at once.</p>
		<div class="padded disabled">
			<style>
			.classylist{line-height: 90%;}
			.classylist li{padding-bottom: 10px;}
			</style>
			<h5 class="flow-text bold">/bos/core/css</h5>
			<ul class="none classylist files">
				...
				<li><i class="folder-plain"></i> <strong>/grids</strong><br /><small>(contains multiple grid methods)</small></li>
				...
				<li><i class="folder-plain"></i> <strong>/molds</strong><br /><small>(contains additional CSS files for miscellaneous content)</small></li>
				...
				<li><strong><i class="css"></i> buff.css</strong><br /><small>(CSS blends and filters)</small></li>
				...
				<li><strong><i class="css"></i> fux.css</strong><br /><small>(form user experience styles)</small></li>
		...
		<p class="bitstream" style="margin-bottom: 1em;">CSS variables are used to configure some of the core components. This allows for some flexibility in customizing global core classes. To modify the values, edit the <span class="bold red">bos/core/css/variables.css</span> file.</p>
	...
	<p class="spacer"></p>
	<h4 class="charcoal white-t flow-text bitstream">MOLDS CSS</h4>
	<div class="flex bitstream"><div class="padded half">
		<p>Additional CSS files for multimedia, shapes, and other UI/UX elements are found in the <span class="bold red">bos/core/css/molds</span> directory. All CSS files within this directory are also imported into the <em>bos/core/css/construct.css</em> file.</p>
		<p class="indent" style="margin-top: 1rem;">These files are needed as they are part of the CORE components (mostly BUIX). They are primarily to be used on the front-end.</p>
	</div><div class="padded half">
		<div class="padded disabled">
			<h5 class="flow-text bold">/bos/core/css/molds</h5>
			<ul class="none classylist files">
				<li><strong><i class="css"></i> multimedia.css</strong><br /><small>(CSS for audio, video, &amp; GIF players)</small></li>
				<li><strong><i class="css"></i> presenter.css</strong><br /><small>(CSS for Presenter slider)</small></li>
				<li><strong><i class="css"></i> shapes.css</strong><br /><small>(shaped elements library)</small></li>
				<li><strong><i class="css"></i> uiux.css</strong><br /><small>(CSS for Age Verify, Cookie Consent, Exit Intent, &amp; Timeline)</small></li>
			</ul>
		</div>
	</div></div>