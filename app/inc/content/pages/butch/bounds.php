...
<div class="flex">
	<div class="padded half">
		<p class="padded info"><span class="flow-text bold">Offset Outlines</span><br />Offset outlines around an element by 2, 5, 10, 15, or 20px:<br /><strong>.os-2<br />.os-5<br />.os-10<br />.os-15<br />.os-20</strong></p>
...
<!-- SHAPES -->
<h3 class="fluid-text monolisk" id="shapes">Shapes</h3>
<div class="flex bitstream"><div class="padded half">
	<p>Shapes are simple CSS classes that can be applied to any element to make it into a shape. When floated left or right, a shape element can have content wrap around it.</p>
	<p class="indent" style="margin-top: 1rem;">To see examples and documentation, see the demo.</p>
...
<div class="flex clean"><div class="padded third">
