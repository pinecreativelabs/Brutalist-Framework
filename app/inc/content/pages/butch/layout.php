			...
			<div class="flex">
				...
				<div class="half padded">
					...
					<strong>.half</strong> <small>[50% width]</small><br /><strong>.third</strong> <small>[33% width]</small><br /><strong>.two-thirds</strong> <small>[67% width]</small><br />
					<strong>.fourth</strong> <small>[25% width]</small><br />
					...
					If a more robust layout grid is needed, take a look at our <a href="grids.php" class="lemonlink"><strong>multi-method layout grid system</strong></a>.</p>
				</div>
			</div>
			<p class="spacer"></p>
