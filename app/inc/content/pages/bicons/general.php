				<!-- Dangerous -->
				<p class="bold flow-text">/// DANGER ZONE ///</p>
				...
				<!-- Directional -->
				<p class="bold flow-text">Directional</p>
				<p class="col3 gap20" style="margin-bottom: 1em;">
					<i class="bi bi-converge-right"></i> converge-right<br /><i class="bi bi-converge-left"></i> converge-left<br />
					<i class="bi bi-charrow"></i> charrow<br /><i class="bi bi-farrow"></i> farrow<br />
					<i class="bi bi-warrow-left"></i> warrow-left<br /><i class="bi bi-warrow-right"></i> warrow-right<br />
					<i class="bi bi-next"></i> next<br /><i class="bi bi-prev"></i> prev<br />
					<i class="bi bi-left"></i> left<br /><i class="bi bi-right"></i> right<br /><i class="bi bi-up"></i> up<br /><i class="bi bi-down"></i> down<br />
					<i class="bi-down-right"></i> down-right<br /><i class="bi bi-up-right"></i> up-right<br />
					<i class="bi bi-point-left"></i> point-left<br /><i class="bi bi-point-right"></i> point-right<br />
					<i class="bi bi-two-way"></i> two-way<br /><i class="bi bi-two-way-o"></i> two-way-o<br />
				</p>
					
				<!-- Sports and Recreation -->
				<p class="bold flow-text">Sports &amp; Recreation</p>
				<p class="col3 gap20" style="margin-bottom: 1em;">
				...
				<!-- Currency -->
				<p class="bold flow-text">Currency</p>
				<p class="col3 gap20" style="margin-bottom: 1em;">
					<i class="bi bi-bitcoin"></i> bitcoin<br /><i class="bi bi-euro"></i> euro<br /><i class="bi bi-kip"></i> kip<br />
					<i class="bi bi-lira"></i> lira<br /><i class="bi bi-peso"></i> peso<br /><i class="bi bi-won"></i> won
				</p>
				...
				<!-- Other Symbols -->
				<p class="bold flow-text">Other Symbols</p>
				<p class="col3 gap20" style="margin-bottom: 1em;">
					<i class="bi bi-amp"></i> amp<br /><i class="bi bi-alternate"></i> alternate<br /><i class="bi bi-angle"></i> angle<br />
					<i class="bi bi-audio"></i> audio<br /><i class="bi bi-awareness"></i> awareness<br /><i class="bi bi-mining"></i> mining<br />
					<i class="bi bi-balance"></i> balance / justice<br /><i class="bi bi-bowtie"></i> bowtie<br />
					...
					<i class="bi bi-link"></i> link<br /><i class="bi bi-loz"></i> loz<br /><i class="bi bi-atomic"></i> atomic<br />
					<i class="bi bi-medical"></i> medical<br /><i class="bi bi-metro"></i> metro<br />
					<i class="bi bi-music"></i> music<br /><i class="bi bi-musical"></i> musical<br /><i class="bi bi-symphony"></i> symphony<br />
					<i class="bi bi-no-smoking"></i> no-smoking<br /><i class="bi bi-smoking"></i> smoking<br /><i class="bi bi-squiggle"></i> squiggle<br />
					<i class="bi bi-prescribe"></i> prescribe<br /><i class="bi bi-temperature"></i> temperature<br /><i class="bi bi-celsius"></i> celsius<br />
					<i class="bi bi-farenheit"></i> farenheit<br /><i class="bi bi-100"></i> real / 100<br />
					...
					<i class="bi bi-gay"></i> gay<br /><i class="bi bi-lesbian"></i> lesbian<br /><i class="bi bi-divorce"></i> divorce<br /><i class="bi bi-family"></i> family<br />
					<i class="bi bi-marriage"></i> marriage<br /><i class="bi bi-partners"></i> partners<br />
					<i class="bi bi-paws"></i> paws<br /><i class="bi bi-strong"></i> strong / strength<br />
				...
				<!-- Objects -->
				<p class="bold flow-text">Objects</p>
				<p class="col3 gap20" style="margin-bottom: 1em;">
				...
				<!-- FREAK show -->
				<p class="flow-text bold slime-t glitch">FrEaK sHoW</p>
				<p class="col3 gap20" style="margin-bottom: 1em;">
					<i class="bi bi-alien"></i> alien<br /><i class="bi bi-bat"></i> bat<br /><i class="bi bi-clown"></i> clown<br /><i class="bi bi-evil"></i> evil<br />
					<i class="bi bi-fairy"></i> fairy<br /><i class="bi bi-freak"></i> freak<br />
