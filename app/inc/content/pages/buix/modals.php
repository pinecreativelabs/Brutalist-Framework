				...
				<p>Modals are popup boxes that open when a user clicks on a link. There are two types of Modals: <em>Vanilla</em> and <em>Lite</em>.</p>
				<h4 class="flow-text white-t charcoal">Vanilla Modals</h4>
				<p class="requiresbox"><span class="flow-text">REQUIRES:</span><br /><em>core/jab/buix.js</em></span></p>
				<p>Vanilla modals use plain vanilla javascript (no dependencies). Display a modal with any type of content. Users can close the modal either by clicking anywhere outside of it, or the X in the top right corner. There are three components that are needed.</p>
				...
				<!-- Lite Modals -->
				<h4 class="charcoal flow-text white-t" id="modals-lite">Lite Modals</h4>
				<p>Pure CSS modals for simple and lightweight content!</p>
