...
<div class="dune flex" style="height: 25vh; margin: 0;">
	<div class="shape point-right sand center flex middle" style="min-width: 15vw; height: 100%; margin: 0 1rem 0 0;">
		<div class="fluid-text-h1" style="margin-left: -20px;"><i class="bi bi-info charcoal-t sand-t-s"></i></div>
	</div>
	<div class="flex middle column charcoal-t sand-t-s">
		<h1 class="fluid-text start monolisk" style="margin: -10px 0 0 0; font-weight:900;">About BF</h1>
		<h2 class="flow-text baffle start depixel" style="margin: 0; padding: 0;">All About Building Brutality</h2>
	</div>
</div>
...
<div class="fossil padded smoke-t">
	<div class="wrap-1200">
		...
		<p class="bitstream" style="margin-top: 1em;">For purposes of transparency, you can get an idea of what's being planned for future versions by viewing our Roadmap:<br /><br />
			<a href="https://github.com/pinecreativelabs/Brutalist-Framework/wiki/Roadmap" target="_blank" class="flow-text btn small-btn terminal hue-h b-s-t">View Roadmap &raquo;</a>
		</p>
		<p class="spacer"></p>
	</div>
</div>
