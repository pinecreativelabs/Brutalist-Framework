...
<div class="passion white-t courier flex" style="height: 25vh; margin: 0;">
	<div class="shape point-right violence center flex middle" style="min-width: 15vw; height: 100%; margin: 0 1rem 0 0;">
		<div class="fluid-text-h1" style="margin-left: -20px;"><i class="bi bi-cone"></i></div>
	</div>
	<div class="flex middle column rebecca-t rice-t-s bitstream">
		<h1 class="fluid-text" style="margin: -10px 0 0 0;">Flavors</h1>
		<h2 class="flow-text baffle start" style="margin: 0; padding: 0;">Color Classes Library</h2>
	</div>
</div>

<div class="fossil">
	<div class="padding smoke-t bitstream"><div class="wrap-1200">
		<p class="flow-text"><em>Flavors</em> is a delicious buffet of colors, baked with CSS love.</p>
		<p class="requiresbox"><span class="flow-text bold"><em>core/css/flavors.css</em></span></p>
	</div></div>
	<div class="padded">
		...
		<div class="flex">
			<div class="glued start sidebar">
				<nav class="simple nav3">
					<ul class="courier flow-text">
						...
						<li><a href="#mixed">Mixed Flavors</a></li>
			...
			<div class="main smoke-t bitstream padded">
				...
				<ul class="none flow-text bold info inline-block">
					...
					<li>.auxilary <span class="auxiliary">&nbsp;&nbsp;</span></li>
